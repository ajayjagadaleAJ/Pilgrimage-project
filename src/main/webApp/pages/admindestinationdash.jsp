                ...
                <div class="card"> -->
                  ...
                  <div class="details">
                    <div class="recentOrders">
                        <div class="topbar">
                            <h2>Packages</h2>
                            <a href="#" downloadCSV class="btn">View All</a>
                        </div>
                        
                        <table border="5px" style="background-color:white;background-image: linear-gradient( to bottom right, Orange, white,green );">
                            <thead>
                                <tr>
                                    <td>Id</td>
                                    <td>Package Name</td>
                              ...
                              <c:forEach items="${dd}" var="e">
                                <tr>
                                    ...
                                    <td>
                                      <img src="Destination_Images/${e.file}" height="50px" width="50px"></img>
                                    </td>
                                   
                                   <td>
                                   
                                    <a href="updatedestini/${e.did}" style="color: green;"><ion-icon name="create"></ion-icon></a> | <a href="deletedestination/${e.did}" style="color:red;";><ion-icon name="trash"></ion-icon></a>
                                   </td>
                                </tr>
                              </c:forEach>
