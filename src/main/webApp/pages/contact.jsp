...
<html lang="en">
<head>
  <link rel="icon" href="images/pg1.jpg" type="image/x-icon">
...
<body>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg14.jpg');">
  ...
  <div class="container">
    <div class="row d-flex contact-info">
      <div class="col-md-3 d-flex">
       ...
       <p><a href="https://www.google.com/maps/place/CRAVITA+TECHNOLOGIES+INDIA+PRIVATE+LIMITED/@18.5223896,73.8517452,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc2bf145158a213:0x909de72fabe33eee!8m2!3d18.5223896!4d73.8517452!16s%2Fg%2F11fhzj7y4z?entry=ttu">Pune Maharashtra India</a></p>
     </div>
   </div>
   <div class="col-md-3 d-flex">
     <div class="align-self-stretch box p-4 text-center">
     ...
     <p><a href="tel://8530737598">+91 8530737598</a></p>
   </div>
 </div>
 <div class="col-md-3 d-flex">
   <div class="align-self-stretch box p-4 text-center">
   ...
   <p><a href="mailto:info@yoursite.com">Risky143@ gmail.com</a></p>
 </div>
</div>
<div class="col-md-3 d-flex">
 <div class="align-self-stretch box p-4 text-center">
 ...
 <p><a href="index">Risky Travel Agency.com</a></p>
</div>
</div>
</div>
</div>
  ...
  <div class="container">
    <div class="row block-9">
      <div class="col-md-6 order-md-last d-flex">
        <form action="contactstore" class="bg-light p-5 contact-form" method="post">
          <div class="form-group">
            <input type="hidden" class="form-control" placeholder="Id" name="cid" >
          </div>
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Your Name" name="cname" required>
          </div>
          <div class="form-group">
            <input type="text" class="form-control" placeholder="Your Email" name="cemail"required>
          </div>
          <div class="form-group">
            <input type="tel" class="form-control" placeholder="Your Phone Number" name="cmobile"required>
          </div>
          <div class="form-group">
            <textarea   cols="30" rows="7" class="form-control" placeholder="Message" name="cmessage"required></textarea>
          </div>
          <div class="form-group">
            <button type="submit" onclick ="myFunction()" value="Send Message" class="btn btn-primary py-3 px-5" required="">Send Message</button>
          </div>
        </form>
      ...
      <div class="col-md-6 d-flex">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1675.4848909085283!2d73.85067777246519!3d18.52325209276802!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf145158a213%3A0x909de72fabe33eee!2sCRAVITA%20TECHNOLOGIES%20INDIA%20PRIVATE%20LIMITED!5e0!3m2!1sen!2sin!4v1709622641335!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        ...
        <div class="ftco-footer-widget pt-md-5 mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              ...
              <li><a href="index"><span class="icon fa fa-paper-plane"></span><span class="text">info@yourdomain.com</span></a></li>
            </ul>
          </div>
        </div>
      </div>
