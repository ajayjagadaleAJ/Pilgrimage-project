...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index">Risky<span>Travel Agency</span></a>
				...
				<div class="row d-flex">
					<div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
						<div class="w-100">
							...
							<p>
A lively stream named Adventure Stream flows through, offering the perfect backdrop for thrilling activities in our adventure tourism system – from kayaking to scenic hikes, it's the heart of unforgettable experiences.</p>
							...
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-1 d-block img" style="background-image: url(images/services-1.jpg);">
									...
									<div class="media-body">
										...
										<p>
											Adventure stage for thrilling and scenic hikes for unforgettable experiences.</p>
									</div>
								</div>      
							</div>
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
						...
						<div class="carousel-destination owl-carousel ftco-animate">
							<div class="item">
								<div class="project-destination">
									<a href="https://maps.app.goo.gl/Uqd22ZBqjdudXtds5" class="img" style="background-image: url(images/place-1.jpg);">
										<div class="text">
											<h3>Gulmarg</h3>
											<span>Tours</span>
										</div>
							...
							<div class="item">
								<div class="project-destination">
									<a href="https://maps.app.goo.gl/64Y61hTqLe8aQreS6" class="img" style="background-image: url(images/place-2.jpg);">
										<div class="text">
											<h3>Manali</h3>
											<span>Tours</span>
										</div>
							...
							<div class="item">
								<div class="project-destination">
									<a href="https://maps.app.goo.gl/ZXbTDfKij7PLoFW56" class="img" style="background-image: url(images/place-3.jpg);">
										<div class="text">
											<h3>Rishikesh</h3>
											<span>Tours</span>
										</div>
							...
							<div class="item">
								<div class="project-destination">
									<a href="https://maps.app.goo.gl/LmVhNaddkLVmPjGe7" class="img" style="background-image: url(images/place-4.jpg);">
										<div class="text">
											<h3>Aamby Valley City</h3>
											<span>Tours</span>
										</div>
									</a>
								</div>
							...
							<div class="item">
								<div class="project-destination">
									<a href="https://maps.app.goo.gl/8xArv22nhUxq5cvV9" class="img" style="background-image: url(images/place-5.jpg);">
										<div class="text">
											<h3>Goa</h3>
											<span>Tours</span>
										</div>
		...
		<section class="ftco-section">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/Gulmark.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">3 Days Tour</span>
								<h3><a href="#">Cable Car</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Gulmarg,Jammu & Kashmir</p>
								<ul>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/skiing-manali.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">5 Days Tour</span>
								<h3><a href="#">Skying</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Gulmarg,Jammu & Kashmir</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Apharwat Mountain</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/pony-ride-kashmir.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">2 Days Tour</span>
								<h3><a href="#">Horse Riding</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Gulmarg,Jammu & Kashmir</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Khilanmarg peak</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/paragliding.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">5 Days Tour</span>
								<h3><a href="#">Paragliding</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Manali,Himachal Pradesh</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Solang Valley</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/Zipling-manali.jpeg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">5 Days Tour</span>
								<h3><a href="#">Ziplling</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Manali,Himachal Pradesh</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/manali\ cycling.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">7 Days Tour</span>
								<h3><a href="#">Leh Cycling</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Manali,Himachal Pradesh</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Rohtang La Pass</li>
								</ul>
							</div>
						</div>
					</div>
              <!-- new Tours -->
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/bungee-jumping.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">7 Days Tour</span>
								<h3><a href="#">Bungee Jumping</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Rishikesh, Uttarakhand </p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Dhalwala</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/Rafting.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">5 Days Tour</span>
								...
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Shivpuri</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/trekkingRishikesh.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">7 Days Tour</span>
								...
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Ropkund</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/climbing.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">7 Days Tour</span>
								<h3><a href="#">Waterfall Rappelling</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Aamby Valley, Maharashtra</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Lonavala</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/watersport.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">2 Days Tour</span>
								<h3><a href="#">Water Sports</a></h3>
								<p class="location"><span class="fa fa-map-marker"></span>Aamby Valley, Maharashtra</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
					...
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/pawnacamp.jpeg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">3 Days Tour</span>
								...
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Kamshet</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/bananaride.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">1 Days Tour</span>
								<h3><a href="#">Banana Boat Ride </a></h3>
								<p class="location"><span class="fa fa-map-marker"></span> Goa, Maharashtra</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Baga Beach</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/flyboard.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">1 Days Tour</span>
								<h3><a href="#"></a>Flyboard Ride</h3>
								<p class="location"><span class="fa fa-map-marker"></span> Goa, Maharashtra</p>
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Chopra River</li>
								</ul>
							</div>
						</div>
					</div>
					<div class="col-md-4 ftco-animate">
						<div class="project-wrap">
							<a href="#" class="img" style="background-image: url(images/tours/Scuba.jpg);">
								<span class="price">$550/person</span>
							</a>
							<div class="text p-4">
								<span class="days">2 Days Tour</span>
								...
								<ul>
									<li><span class="flaticon-shower"></span>2</li>
									<li><span class="flaticon-king-size"></span>3</li>
									<li><span class="flaticon-sun-umbrella"></span>Near Grande Island</li>
								</ul>
							</div>
						</div>
					</div>
