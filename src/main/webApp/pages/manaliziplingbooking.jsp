      ...
      <div class="row gx-5">
        <aside class="col-lg-6">
          <div class="border rounded-4 mb-3 d-flex justify-content-center">
              ...
              <img style="max-width: 80vh; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="images/tours/Zipling-manali.jpeg" />
            </a>
          </div>
        ...
        <main class="col-lg-6">
          <div class="ps-lg-3">
            ...
            <a href="manalipackagedetail"button class="btn" type="submit" style="background-color:rgb(63, 224, 239);">&laquo; Previous </a>
