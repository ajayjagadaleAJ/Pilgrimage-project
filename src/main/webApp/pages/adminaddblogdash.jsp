...
"> 
                <div class="container">
                            <center>
                            <div class="title"style="color:red"> + Add Blog</div>
                        </center>
                            <div class="content">
                              ...
                              <form action="blogpost" method="post" enctype="multipart/form-data">
                                <div class="user-details">
                                  <div class="input-box">
                                    ...
                                    <input type="text" placeholder="Enter tour name" name="bname" required>
                                  </div>
                                  <div class="input-box">
                                    <span class="details">Blog Date</span>
                                    <input type="date" placeholder="Enter your tour" name="bdate" required>
                                  </div>
                                  <div class="user-details">
                                  <div class="input-box">
                                   <span class="details">Blog content</span>
                                   <textarea cols="80" rows="5"placeholder ="Enter content" name="bcontent" maxlength="2000" required></textarea>
                                 </div>
                               </div>
