        ...
        <div class="main">
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    <table border="5px" style="background-color:aqua;background-image: linear-gradient( to bottom right, white,grey,white );">
                        <thead>
                            <tr>
                                <td>Id</td>
                                <td>Name</td>
                          ...
                          <c:forEach items="${mm}" var="e">
                            <tr>
                                ...
                                <td>${e.ugender}</td>
                               <td>
                                <a href="update/${e.id}" style="color: green;"><ion-icon name="create"></ion-icon></a> | <a href="delete/${e.id}" style="color:red;";><ion-icon name="trash"></ion-icon></a>
                               </td>
                            </tr>
                          </c:forEach>
              ...
              <div class="container">
                <div>
                  <form action="savedata" method="post">
                    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg12.jpg');">
                      <div class="container">
                              ...
                              <div id="booking" class="section">
                                <div class="section-center">
                                  <div class="container">
                                   ...
                                   <center><h1 style="color: white"> + Add Users </h1></center>
                                </div>
...
<script>
  ...
  function filterData() {
      ...
      const tableRows = document.querySelectorAll('.details .recentOrders table tbody tr');
