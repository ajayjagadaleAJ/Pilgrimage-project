...
<body>
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name">PILGRIMAGE</span>
        </div>
...
%> 
                ...
                <li><a href="userdetails">
                    ...
                    <span class="link-name">Account Details</span>
                </a></li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="password" name="upass"id="password" pattern=".{6,}" title="Password must be at least 6 characters long"  value="" required>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="password" name="ucpass" required>
                                                            <span class="select-arrow"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-btn"><br>
                                                                ...
                                                                <button onclick="myFunction()" class="submit-btn" type="submit">Register</button>
