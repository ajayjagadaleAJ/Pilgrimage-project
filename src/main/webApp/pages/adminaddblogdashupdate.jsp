            ...
            <div class="container">
             <div class="cardBox"> 
              ...
              <div class="card" style="border-radius:30px;font-size:x-large;"> 
                <div class="container">
                            <center>
                            <div class="title"style="color:red"> + Update Blog</div>
                        </center>
                            <div class="content">
                   <!-------------- form action start from here ------------------>
                              <form action="/updateblog" method="post">
                                <div class="user-details">
                                    <div>
                                        <input type="hidden" placeholder="Enter tour name" name="bid" value="${kk.bid}" required>
                                    </div>
                                  <div class="input-box">
                                    <span class="details">Blog Name</span>
                                    <input type="text" placeholder="Enter tour name" name="bname" value="${kk.bname}" required>
                                  </div>
                                  <div class="input-box">
                                    <span class="details">Blog Date</span>
                                    <input type="date" placeholder="Enter your tour" name="bdate" value="${kk.bdate}" required>
                                  </div>
                                  <div class="user-details">
                                  <div class="input-box">
                                   <span class="details">Blog content</span>
                                   <textarea cols="80" rows="5"placeholder ="Enter content" name="bcontent" value="${kk.bcontent}"></textarea>
                                 </div>
                               </div>
                               
                                <label for="myfile">Add Tour Image :</label><br><br> 
                                <input type="file" id="img" name="filename"  value="${kk.file}"accept="image/*">
