                ...
                <div class="card"> -->
                  ...
                  <div class="details">
                    <div class="recentOrders">
                        ...
                        <table border="5px" style="background-image: linear-gradient( to bottom right, Orange, white,green );">
                            <thead>
                                <tr>
                                    <td>Id</td>
                                    <td>Blog Name</td>
                              ...
                              <c:forEach items="${bb}" var="e">
                                <tr>
                                    ...
                                    <td>
                                      <img src="Blog_Images/${e.file}" height="50px" width="50px"></img>
                                    </td>
                                   
                                   <td>
                                    <a href="updateblog/${e.bid}" style="color: green;"><ion-icon name="create"></ion-icon></a> | <a href="deleteblog/${e.bid}" style="color:red;";><ion-icon name="trash"></ion-icon></a>
                                   </td>
                                </tr>
                              </c:forEach>
